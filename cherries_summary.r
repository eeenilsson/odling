...
pictures_list <- pictures_list[!duplicated(pictures_list$var), ] ## rm dupl
...
file.create(tmp)
varieties$var[duplicated(varieties$var)]
...
## plot eur_bt blooming times "errorbar" style ----------
