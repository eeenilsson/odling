...
Eftersom det finns en osäkerhet i uppgifterna om blomningstid bör du även kontrollera med din lokala plantskola vilka sorter som brukar fungera tillsammans. Pollinationschemat bör därför bara användas som en fingervisning om vilka sorter som kan blomma samtidigt. Uppgifterna om genetisk kompatibilitet är troligen mer säkra och icke-kompatibla sorter bör undvikas. Dock är det inte givet att det genetiska material som använts för bestämning av S-haplotyp alltid överensstämmer med den sort som säljs under ett visst namn (Se Nybom 2012).
...
Pollinatörer inom det gröna fältet bör fungera, särskilt om du hittar information från andra källor om att de är lämpliga pollinatörer. För pollinatörer inom det blå eller röda fältet som rekommenderas av andra källor kan det vara värt att kolla upp om de verkligen blommar samtidigt.
