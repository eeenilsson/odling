...
Relativa värden (kvintiler) från låg (1) till hög (5). Blomningstiden från tidigast (1) till senast (5) _av dessa surkörsbär_, dvs korresponderar EJ till blomningsgrupperna för sötkörsbär. Skuggmorell anges i vissa källor blomma samtidigt som vissa sena sorter av sötkörsbär.
...
sour_dk_phenology <- read.csv("../sour_dk_phenology.csv")
## knitr::kable(sour_dk_phenology)

reactable(sour_dk_phenology, ## sorting
          filterable = TRUE,
          bordered = TRUE,
          highlight = TRUE,
          striped = FALSE,
