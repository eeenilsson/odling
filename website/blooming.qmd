...
Trädets ålder: Trädens ålder var 3-13 år (Mdn 5, IQR 4-7) och effekten på blomingstidens start var 0.4 dagar tidigare per år > 3. Det fanns ingen effekt av ålder på tiden från start till full blomning eller blomningens varaktighet.
...
Sammanfattningsvis kan sägas att blomningstidens start är tidigare för äldre träd (kanske upp till en vecka tidigare för träd som är kring 10 år jämfört med 3 år gamla), och att för 80% av sorterna startar blomningen i medeltal inom 11 dagar från varandra, vanligen med full blomning inom 9-11 dagar och en varaktighet på omkring 16-20 dagar beroende på sort. Medelvärdet för både start, tid till full blomning och blomningens varaktighet varierar dock relativt mycket från år till år. Detta betyder att information om tex blomningstidens längd för en viss sort i jämförelser beror mycket på vilket år information för den sorten registrerats.
