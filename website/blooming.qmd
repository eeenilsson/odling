...
## Hur mycket behöver blomningstiderna överlappa för pollination?

En dansk studie (Vittrup 1998) av ett stort antal (kring 100 st) sorter visade att alla sorter _i medeltal_ överlappade i blomningstid minst fem dagar, men att detta varierade från år till år. Författarna menar att det främst är de sorter som blommar allra tidigast och senast som man ej kan anta att blomningstiderna sammanfaller tillräckligt för pollination under vissa år.

![Vittrup 1998. Blomningstid. Medelvärden för start, full blomning (markerad med en prick) och blomningens längd. På x-axeln anges antal dagar från start av blomning för den tidigaste sorten. Tidpunkten fyra dagar efter full blomning är markerad med ett streck.](../../dropbox/images/plants/plot_vittrup_bt.png)

<!-- https://www.ishs.org/ishs-article/423_4 Vittrup1996.pdf2  -->
<!-- "The potential of cross pollination in sweet cherry with regard to overlap of the flowering period was analysed on the basis of flowering records collected over 20 years. The limit for sufficient overlap was fixed at one fourth of the total flowering period for all cultivars with a minimum of 4 days. Based upon average data all cultivars seem to be mutual pollinators. -->
<!-- However, the annual variation in overlap is considerable and should be given more attention. Even when this variation is taken into account almost all varieties overlap sufficiently in every year, but precautions should be taken with the earliest and the latest flowering cultivars. It is also shown that even the mean flowering dates over 10 years deviate considerably from those collected over 20 years. The total flowering period for all cultivars varied from 13 to 38 days." -->

I figuren nedan visas medelvärden för tid till start (10% av blommorna öppna), full blomning och blomningens slut (då alla blomblad fallit av) i europeiska data (se Wenden 2016). Dessa har justerats för ort och år. Som kan ses överlappar blomningstiderna även för de relativt tidigblommande sorterna (tex Lapins) och de senblommande (tex Regina). Antar man att en blomma är öppen i tre till fem dagar bör den effektiva blomningstiden dock upphöra redan tre till fem dagar efter full blomning. Antar man att det behövs kring fem dagars överlappning kan 'Lapins' enligt dessa resultat precis hinna pollinera 'Regina' om de blommar som de i medeltal gör.

![Blomningstid. Medelvärden för start, full blomning (markerad med en prick) och blomningens längd, justerat för ort och år. På x-axeln anges antal dagar från start av blomning för den tidigaste sorten. Tidpunkten fyra dagar efter full blomning är markerad med ett streck.](../../dropbox/images/plants/plot_eur_bt.png)
...
## Analys av blomningstid

Data från två platser i Frankrike (Toulenne och Balandran) valdes ut från de data som användes i artikeln av Wenden 2016. Om en viss sort fanns registrerad under mer än ett år per plats togs medelvärdet per sort och plats. Registreringar fanns för åren 1981-2015 (ej alla sorter varje år) och för ca 170 sorter.

Medelvärdet för blomningstidens start var den 25 april. Tiden till full blomning var noterad till 0-20 dagar (Mdn 7.4, IQR 6-9) men 4-10 dagar i 80% av fallen. Blomningens varaktighet var noterad till 1-35 dagar (Mdn 13, IQR 11-16 dagar) men 8-19 dagar i 80% av fallen.

Först beräknades effekten av år, plats och trädets ålder (justerat för varandra samt för sort). Data som saknade uppgifter om trädets ålder (n = 64) eller där åldern var <3 år (n = 1012) togs bort, vilket lämnade n = 6009 datapunkter. Blomningens start var i medeltal en dag tidigare i Balandran än Toulenne och tiden från start till full blomning liksom blomningens varaktighet tre dagar kortare. 

Trädets ålder: Trädens ålder var 3-13 år (Mdn 5, IQR 4-7) och  blomingstiden startade något tidigare för äldre träd (ungefär en dag tidigare för ålder 4.5-6 och 1.5 dagar tidigare för äldre träd, jämfört med ålder <4.5 år). Det fanns ingen effekt av ålder på tiden från start till full blomning eller blomningens varaktighet.

Sort: Effekten av sort var mellan 19 dagar tidigare- och 13 dagar senare start av blomning (Mdn 0.9, IQR -1 till 4), men för 80% av sorterna var spannet 4 dagar tidigare till 7 dagar senare än medelvärdet. Tiden från start till full blomning (medelvärde = 10 dagar) varierade upp till 5 dagar mellan sorterna (men endast 2 dagar för 80 % av sorterna). Blomningens varaktighet (M 18) varierade upp till 8 dagar mellan sorterna (men tre dagar för 80% av sorterna).

År: Medelvärdet för blomningstidens start varierade i ett spann på ca 30 dagar mellan åren (17 dagar för 80% av åren), tiden till full blomning inom ett spann på 7 dagar (4 dagar för 80 % av åren) och varaktigheten med 10 dagar (9 dagars variation för 80 % av åren).

Delar man in åren i "tidiga", "medel", och "sena" år (baserat på tertiler av medianvärdet för start av blomning) kan man se att år med sen start av blomning har ca 1 dags kortare tid till full blomning, 2 dagar kortare varaktighet och 4 dagar senare till mognad, jämfört med "tidiga" år.

Sammanfattningsvis kan sägas att blomningstidens start är något tidigare för äldre träd, och att för 80% av sorterna startar blomningen i medeltal inom 11 dagar från varandra, vanligen med full blomning inom 9-11 dagar och en varaktighet på omkring 16-20 dagar beroende på sort. Medelvärdet för både start, tid till full blomning och blomningens varaktighet varierar dock från år till år. Detta betyder att information om tex blomningstidens längd för en viss sort i viss mån beror på vilket år information för den sorten registrerats.

För att närmare undersöka effekten av sort beräknades sedan tiden för blomning och mognad relativt startdatum respektive varaktighet för sorten "Burlat" (somm fanns registrerad för samtliga år).

Effekten på medelvärdet för de olika parametrarna var enligt följande (min till max med 80% av fallen inom parentes):

- Blomningens start relativt 'Burlat': Variation i medelvärdet beroende på år -4.7 till 2.5 (-1.3 till 1.3) dagar; sort -19 till 12 (-4.1 till 6.2) dagar.

<!-- Osäkerhet pga ålder och år: relativ start 1d + 2d, full 2d dvs ca upp till kanske 4d kortare överlapp pga år-->

- Mognad: År -13 till 24 (-3.5 till 14); sort -9.3 till 36 (3.4 till 28). 

- Tid till full blomning (% av Burlat): År -11 till +27 (8.4 till 12) procentenheter; sort -31 till +52 (8.5 till 17) procentenheter.

- Varaktighet (procentenheter): År -16 till 22 (-8.2 till 15); sort -24 till 41 (-4.6 till 17).

Ålder hade effekt på: Relativ start av blomningen (-0.4 dagar) men ej på de övriga parametrarna.

Plats hade (liten) effekt på: Relativ tid till full blomning (-9 procentenheter), relativ varaktighet (-1.7 procentenheter), och relativ mognad (+3 dagar).

För start av blomningstid 
