...
För att en sort skall kunna pollinera en annan behöver de blomma samtidigt (givaren måste frisätta pollen under den period då mottagarens ägg är mottagligt). De bästa förutsättningarna för befruktning inom 2 dagar efter blomning. Efter 7 dagar är det ca 30% av blommorna som fortfarande kan befruktas hos de flesta sorter och detta är temperaturberoende på så vis att svalare temperatur ger en mer långvarig period då blomman kan befruktas.
