...
Om blomningen infaller före den sista frosten finns en risk att blommorna förstörs av den. Genomsnittligt datum för sista frost är mellan mitten av april och mitten av juni beroende på var i landet du bor. Tex i Örebro inträffar den sista frosten under 30% av vårarna före den 2 maj, 50 % före 9 maj, 70% före 20 maj, och 90% före 26 maj.<!-- [tex i Örebro normalt 1 apr till 15 maj, största intervall 1 apr till 1 jun] --> Detta kan jämföras med start av körsbärsblomningen i norska Ullensvang 6-14 maj. En kall vår gör sannolikt att körsbären börjar blomma senare, men vid en sen köldknäpp kan blommorna skadas.

Se översiktskarta från [SMHI](https://www.smhi.se). Mer detaljerad statistik kan fås från "odlingskalendern" på [vackertväder.se](https://www.vackertvader.se).
<!-- https://www.vackertvader.se/%C3%B6rebro/odla#frost-datum -->

Figuren nedan visar hur stor andel av åren 1991-2023 vars sista frost kom innan ett visst datum. Exempel: Under 50 % av åren inföll sista frosten före 8 maj, 75% före 13 maj, och 100% innan 27 maj. Det nedre, blå fältet visar fördelingen av datum för sista frost (inträffar ganska jämnt över perioden, men oftast 1 maj-17 maj)Temperaturdata från SMHI.

![Sannolikhat att sista frosten passerat i Örebro](../../dropbox/images/plants/last_frost_orebro.png){#fig-frost width=100%}
