...
- Blomningens start relativt 'Burlat': Variation i medelvärdet beroende på år -13 till 24 dagar (-3.5 till 14 dagar för 80% av åren); sort -9.3 till 36 (3.4 till 28).

- Tid till full blomning: År -1 till 1.1 (-0.74 till 0.68); sort -2.4 till 3.8 (-0.75 till 1.2).

- Varaktighet: År -2.3 till 2.8 (-0.97 till 1.1); sort -3 till 4.4 (-0.84 till 2).

- Mognad: År -13 till 24 (-3.5 till 14); sort -9.3 till 36 (3.4 till 28)" 

Ålder hade effekt på: Relativ start av blomningen (-0.4) men ej på de övriga parametrarna.

Plats hade (liten) effekt på: Relativ tid till full blomning (-0.7), relativ varaktighet (-0.5), och relativ mognad (+3).
